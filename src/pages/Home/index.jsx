        ...
        {isProviderView ? (
          ...
          <div className="p-4">
            <div className="mb-4 flex gap-6">
              ...
              <button className="rounded-full bg-[#BFAA87] px-5 py-2 font-semibold text-white">
                發起學習
              </button>
            </div>
              ...
              {sortedPosts.map((post) => (
                ...
                >
                  ...
                  <div className="mt-4 flex items-center">
                    ...
                    <button className="ml-auto mr-3 rounded-full bg-amber-600 px-4 py-2 text-sm text-white">
                      學習歷程表
                    </button>
                    <button className="rounded-full bg-slate-200 px-4 py-2 text-sm">
                      傳送訊息
                    </button>
                  </div>
                </Link>
